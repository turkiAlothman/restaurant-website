  ...
  $i++;
   ...
   while($loc[$i]!=")"){
      ...
      $i++;
        ...
        mysqli_query($conn, "UPDATE restaurant SET logo = '$logo' , location = '$new' WHERE name ='$n'");
         $v="<h1 style='color:green;'> location and logo are changed successfully </h1> ";
         }
         else if ($loc != ""){
  ...
  $i++;
   ...
   while($loc[$i]!=")"){
      ...
      $i++;
         ...
         $new = sqrt(intval($x)**2 + intval($y)**2 );
         $new =  intval($new); 
          mysqli_query($conn, "UPDATE restaurant SET location = '$new' WHERE name ='$n'");
         
           $v="<h1 style='color:green;'> location has changed successfully </h1> ";
         }
         
         else if ($logo!=""){
           mysqli_query($conn, "UPDATE restaurant SET logo = '$logo' WHERE name ='$n'");  
            $v="<h1 style='color:green;'> logo has changed successfully </h1> ";
         }
                    ...
                    <div class="container">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >  
                          ...
                          <div class="form-group">  
                            ...
                            <input type="text" placeholder="(x,y)" name="loc" class="form-control" value="">
                          </div> 
                          <div class="form-group">  
                            <label> Logo</label>  
                            <input type="text" name="logo" class="form-control" value="" placeholder="http://.......">  
                          </div> 
