...
$servername = "localhost";
    ...
    die("there is error in connection");}
     ...
     if($_SERVER["REQUEST_METHOD"]=="POST"){
         ...
         $n = $_POST["rl"];
         mysqli_query($conn, "DELETE FROM restaurant WHERE name = '$n'");
         mysqli_query($conn, "DELETE FROM menu WHERE resname = '$n'");
         mysqli_query($conn, "DELETE FROM review WHERE resname = '$n'");
         
         
         $v="<h1 style='color:green;'> restaurant is deleted successfully </h1> ";
                ...
                <div class="row">
                    <div class="container"> 
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >  
                          ...
                          <button type="submit" class="btn btn-success save-btn">remove</button>  
