...
$servername = "localhost";
    ...
    die("there is error in connection");}
     ...
     if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        mysqli_query($conn, "UPDATE menu SET price = '$price' , des = '$des' WHERE name ='$mal' AND resname = '$n' ");
         $v="<h1 style='color:green;'> description and price are changed successfully </h1> ";
         }
         else if ($des != ""){
          
         mysqli_query($conn, "UPDATE menu SET des = '$des' WHERE name ='$mal' AND resname = '$n' ");
         
           $v="<h1 style='color:green;'> description has changed successfully </h1> ";
         }
         
         else if ($price!=""){
           mysqli_query($conn, "UPDATE menu SET price = '$price' WHERE name ='$mal' AND resname = '$n' "); 
            $v="<h1 style='color:green;'> price has changed successfully </h1> ";
         }
